...
//Process form
  if(isset($_POST) && !empty($_POST)){
    ...
    <?
      ...
      //update database
      $updatesql = "
      INSERT INTO categories (category, parent) VALUES ('$category', '$post_parent')";
      if(isset($_GET['edit'])){
...
<div class="row">
  ...
  <div class="col-md-6">
    <form class="form" action="categories.php<?=((isset($_GET['edit']))?'?edit='.$edit_id:'');?>" method="post">
      ...
      <div class="form-group">
        <input type="submit" name="" value="<?=((isset($_GET['edit']))?'Edit': 'Add A');?> Category" class="btn btn-success">
      </div>
    </form>
  </div>
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr class="bg-primary">
          ...
          <td>Parent</td>
          <td> <a href="categories.php?edit=<?=$parent['id'];?>" class="btn btn-xs btn-default">
        ...
        <? while ($child = mysqli_fetch_assoc($cresult)): ?>
          <tr class="bg-info">
            ...
            <td><?=$parent['category'];?></td>
            <td> <a href="categories.php?edit=<?=$child['id'];?>" class="btn btn-xs btn-default">
            <span class="glyphicon glyphicon-pencil"></span> </a>
